  ...
  return (
    <div className="flex items-center justify-center">
            ...
            <div className="mb-2 flex justify-center">
                ...
                <h2 className="text-center text-3xl font-black leading-tight">Sign up to create account</h2>
                <p className="mt-2 text-center text-base text-black/60 dark:text-slate-400">
                    Already have an account?&nbsp;
                    <Link
                        to="/login"
                        className="font-medium text-blue-700 transition-all duration-200 hover:underline dark:text-blue-300"
                    >
                        Sign In
                    </Link>
                </p>
